...
const CommitLog = () => {
  ...
  // Skeleton loader for commit items
  const SkeletonLoader = () => (
    <li className="relative flex animate-pulse gap-x-4">
      <div className="relative flex w-6 justify-center">
        <div className="w-px translate-x-1 bg-gray-200"></div>
      </div>
      <div className="flex-auto rounded-md bg-gray-100 p-3 ring-1 ring-inset ring-gray-200">
